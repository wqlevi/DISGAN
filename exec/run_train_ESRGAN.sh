...
## Pixel Attention Network experiment:
...
##srun python /u/wangqi/torch_env/crop_gan/mains/ESRGAN_WGAN_GP.py --path /ptmp/wangqi/transfer_folder/LS200X_Norm/crops --model_name Jupyter_c14 --checkpoint 0 --precision 0 --batch_size 4
